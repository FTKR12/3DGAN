...
class Options():
    ...
    def initialize(self, parser):
        ...
        # basic parameters
        parser.add_argument('--dataroot', type=str, default='/mnt/TransProgver/dataset')
        parser.add_argument('--output', type=str, default='./output')
        parser.add_argument('--gpu_ids', type=str, default='0,1,2,3', help='gpu ids: e.g. 0  0,1,2, 0,2. use -1 for CPU')
        parser.add_argument('--result_dir', type=str, default='./result', help='models are saved here')
        ...
        parser.add_argument('--batch_size', type=int, default=1, help='input batch(patch) size = patch_size * num_gpus')
        ...
        parser.add_argument('--img_width', default=512, type=int, help=' ')
        parser.add_argument('--img_height', default=512, type=int, help=' ')
        parser.add_argument('--img_depth', default=124, type=int, help=' ')
